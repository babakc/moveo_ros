...
def createGraspPose():
	...
	orientation = quaternion_from_euler(-1.57, 0.10, 0.0)

	grasp.grasp_pose.pose.position.x = -0.02
	grasp.grasp_pose.pose.position.y = 0.35
