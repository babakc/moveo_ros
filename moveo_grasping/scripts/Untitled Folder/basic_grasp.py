...
def createGraspPose():
	...
	grasp.grasp_pose.pose.position.y = 0.30
	grasp.grasp_pose.pose.position.z = 0.15
...
def createPlacePose():
	...
	place_location.place_pose.pose.position.x = 0.50;
	place_location.place_pose.pose.position.y = 0.0;
	place_location.place_pose.pose.position.z = 0.20;
